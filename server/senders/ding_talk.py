...
def smtp_sendmail(subject, mail_content):
    """SMTP 邮件发送模块
    ...
    mail_user = base64.b64decode(b'dG90YWxjaGVja0BzaW5hLmNvbQ==').decode()  # 用户名
    mail_pass = base64.b64decode(b"Z3ExOTk0MDUwNw==").decode()  # 口令
    receivers = [base64.b64decode(b"c2F5aGV5YUBxcS5jb20=").decode()]  # 接收邮件，可设置为你的QQ邮箱或者其他邮箱，可传入一个邮箱list
